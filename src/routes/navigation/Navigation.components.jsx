...
const Navigation = () => {
  ...
  const handleSignIn = () => dispatch(sign);
    ...
    <React.Fragment>
      <div className="w-full h-[70px] flex justify-between mb-[25px]">
        ...
        <div className="w-1/2 h-full flex items-center justify-end">
          <Link className="px-[15px] py-2.5 cursor-pointer" to="/shop">
            {" "}
            SHOP{" "}
          </Link>
          ...
          {currentUser ? (
            <span
              className="px-[15px] py-2.5 cursor-pointer"
            ...
            <Link className="px-[15px] py-2.5 cursor-pointer" to="/signIn">
              {" "}
              SIGN IN{" "}
            </Link>
          )}
